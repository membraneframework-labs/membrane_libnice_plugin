defmodule Membrane.ICE.Connector do
  ...
  @spec clean_ice(connector :: pid()) :: :ok
  def clean_ice(pid) do
    GenServer.call(pid, :clean_ice)
  end
  ...
  @impl true
  def handle_call(:clean_ice, _from, %State{ice: ice, stream_id: stream_id} = state) do
